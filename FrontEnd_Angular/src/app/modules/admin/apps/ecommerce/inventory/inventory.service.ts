...
const URL_ARTICLE = "http://localhost:8080/api/v1/articles"
...
export class InventoryService
{
    ...
    //Added
    ListOfArticles() {
        return this._httpClient.get<Article[]>(URL_ARTICLE + "/findAll");
    }
    //Added
    findArticleById(id:number) {
        return this._httpClient.get<Article>(URL_ARTICLE + "/findById/" + id);

    }
    //Added
    AddArticle(article: Article) {
        return this._httpClient.post(URL_ARTICLE + "/create", article);
    }
    //Added
    EditArticle(article: Article) {
        return this._httpClient.put(URL_ARTICLE + "/update", article);
    }
    //Added
    DeleteArticle(id: number) {

        return this._httpClient.delete(URL_ARTICLE + "/delete/" + id);
    }
