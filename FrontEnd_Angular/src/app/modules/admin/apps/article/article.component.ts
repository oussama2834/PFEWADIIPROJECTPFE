...
import { InventoryProduct, InventoryBrand, InventoryCategory, InventoryTag, InventoryPagination, InventoryVendor } from '../ecommerce/inventory/inventory.types';
...
export class ArticleComponent  implements OnInit{
    ...
    deleteArticle(id: number) {
        this._inventoryService.DeleteArticle(id).subscribe((res) => {
            console.log(res)
        }, (error) => {
            console.log(error)
        })
      ...
      openAddDialog() {
        console.log("opendialog")
          const dialogRef = this._dialog.open(AddArticleComponent, { data:{isAdding: true} });
    ...
    openEditDialog(article:Article) {
        console.log("opendialog")
          const dialogRef = this._dialog.open(AddArticleComponent, { data:{isEditing: true,article} });
         dialogRef.afterClosed().subscribe({
           next: (val) => {
             if (val) {
               this.getAllArticles();
    ...
    getAllArticles() {
        ...
        this._inventoryService.ListOfArticles().subscribe((res) => {
            this.articles = res
...
//Added
    ...
    toggleDetails(articleId: number): void
    {
        ...
        this._inventoryService.findArticleById(articleId)
            .subscribe((article) =>
            {
