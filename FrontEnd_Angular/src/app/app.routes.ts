...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        path: '',
        // canActivate: [AuthGuard],
        // canActivateChild: [AuthGuard], //Avoir commenté ça pendant le test
        component: LayoutComponent,
        resolve: {
        ...
        children: [
            ...
            {path: 'dashboards', children: [
                ...
                { path: 'commande', loadChildren: () => import('app/modules/admin/apps/commande/commande.routes') },
                { path: 'commandeDialog', loadChildren: () => import('app/modules/admin/apps/commande-dialog/commande-dialog.routes') },
                { path: 'article', loadChildren: () => import('app/modules/admin/apps/article/article.routes') },
                { path: 'devis', loadChildren: () => import('app/modules/admin/apps/devis/devis.routes') },
                { path: 'devisDialog', loadChildren: () => import('app/modules/admin/apps/devis-dialog/devis-dialog.routes') },
